        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    @endif
                    @if (config('backpack.base.show_traditional_login'))
                    ...
                    @endif
                    @if (config('backpack.base.show_google_login'))
                    <a class="btn btn-google-login" href="/redirect">Log in with Google</a>
                    @endif
                </div>
            </div>
        </div>
