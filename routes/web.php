...
Route::group([
    ...
    CRUD::resource('teamdcdepartment', 'TeamdcdepartmentCrudController');
    CRUD::resource('teamdcassignment', 'TeamdcassignmentCrudController');
    CRUD::resource('comment', 'StudentcommentCrudController');
});
