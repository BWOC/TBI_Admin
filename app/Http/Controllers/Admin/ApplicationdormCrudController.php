...
class ApplicationdormCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Applicationdorm');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/applicationdorm');
        $this->crud->setEntityNameStrings('applicationdorm', 'applicationdorms');
